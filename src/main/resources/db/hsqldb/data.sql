...
INSERT INTO problema(id,name,puntuacion,descripcion,casos_prueba,salida_esperada,fecha_publicacion,season,season_year,id_competicion) VALUES (3,'La fuga de Rarmon v.2', 5 , 'Debe encontrar la manera de escapar de FuentePalmera', '0 1 2' , '1','2000-04-30','invierno',2020,null);
INSERT INTO problema(id,name,puntuacion,descripcion,casos_prueba,salida_esperada,fecha_publicacion,season,season_year,id_competicion) VALUES (4,'Hello World!', 1 , 'Imprimir n veces "Hello World!"', 'Hello World! \nHello World! \nHello World!' , '1','2000-04-30','primavera',2019,null);
...
INSERT INTO comentarios(id,id_envio,id_alumno,texto) VALUES (1,10,1,'Estoy deseando ver como lo has conseguido!!');
